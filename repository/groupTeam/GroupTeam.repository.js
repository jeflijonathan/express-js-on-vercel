...
class GroupTeamRepository extends basePrismaService_1.default {
    constructor() {
        super(client_1.prisma.groupTeam);
    }
    findAll() {
    ...
    createGroupTeam(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return client_1.prisma.groupTeam.create({ data });
        });
    }
    updateGroupTeam(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.update({ id }, data);
        });
    }
}
exports.default = GroupTeamRepository;
