...
class TradeTypeRepository extends basePrismaService_1.default {
    constructor() {
        super(client_1.prisma.tradeType);
    }
    findAll() {
    ...
    createTradeType(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return client_1.prisma.tradeType.create({ data });
        });
    }
...
exports.default = TradeTypeRepository;
