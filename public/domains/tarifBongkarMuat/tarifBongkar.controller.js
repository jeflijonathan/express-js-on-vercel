...
class TarifBongkarController extends baseController_1.default {
    ...
    getAll() {
        this.router.get("/tarif-bongkar", auth_1.authenticateToken, (0, auth_1.authorizeRoles)("MANAJER"), (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const [error, result] = yield (0, catchError_1.catchError)(this.bongkarMuatService.findTarifBongkarMuat(queryParams));
            if (error)
                return this.handleError(res, error);
            return this.handleSuccess(res, result, "Tarif Bongkar Muat fetched successfully");
        }));
    }
    getById() {
