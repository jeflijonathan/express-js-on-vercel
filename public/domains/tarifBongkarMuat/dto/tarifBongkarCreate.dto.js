...
class CreateTarifBongkarMuatDTO extends baseDTO_1.default {
    static fromCreateBongkarMuat(payload) {
        const _super = Object.create(null, {
            from: { get: () => super.from }
        });
        return __awaiter(this, void 0, void 0, function* () {
            return _super.from.call(this, payload, this.schemaCreateTarifBongkarMuat, CreateTarifBongkarMuatDTO);
        });
    }
}
CreateTarifBongkarMuatDTO.schemaCreateTarifBongkarMuat = zod_1.default.object({
...
exports.default = CreateTarifBongkarMuatDTO;
