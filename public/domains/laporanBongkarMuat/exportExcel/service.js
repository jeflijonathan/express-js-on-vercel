...
class ExcelLaporanBongkarMuatService {
    constructor() {
        this.handleExportReport = (req, workbook) => __awaiter(this, void 0, void 0, function* () {
            ...
            const groupTeams = yield client_1.prisma.groupTeam.findMany({
            ...
            uniqueGroupKeys.sort((a, b) => {
                ...
                const nameA = ((_b = (_a = detailA === null || detailA === void 0 ? void 0 : detailA.sesiBongkar) === null || _a === void 0 ? void 0 : _a.koorlap) === null || _b === void 0 ? void 0 : _b.namaLengkap) || "";
                const nameB = ((_d = (_c = detailB === null || detailB === void 0 ? void 0 : detailB.sesiBongkar) === null || _c === void 0 ? void 0 : _c.koorlap) === null || _d === void 0 ? void 0 : _d.namaLengkap) || "";
                return nameA.localeCompare(nameB);
            });
            uniqueGroupKeys.forEach((key, index) => {
                var _a, _b, _c;
                const [teamId, koorlapId] = key.split('#');
                const detail = laporan.detailLaporan.find(d => d.sesiBongkar.idGroupTeam === teamId && d.sesiBongkar.koorlapId === koorlapId);
                // Use Koorlap Name for the header as requested
                const koorlapName = ((_b = (_a = detail === null || detail === void 0 ? void 0 : detail.sesiBongkar) === null || _a === void 0 ? void 0 : _a.koorlap) === null || _b === void 0 ? void 0 : _b.namaLengkap) || "Default";
                const team = (_c = detail === null || detail === void 0 ? void 0 : detail.sesiBongkar.groupTeam) === null || _c === void 0 ? void 0 : _c.team;
                const teamMembers = team ? team.map(t => t.employee.namaLengkap).join(" & ") : "Unknown Team";
            ...
            sortedDates.forEach((tanggal) => {
                ...
                teamMapping.forEach((map) => {
                    ...
                    const teamDetails = details.filter(d => d.sesiBongkar.idGroupTeam === map.teamId &&
