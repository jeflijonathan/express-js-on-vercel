    ...
    constructor() {
        ...
        this.create = (body) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (recordStevedoringData.length > 0) {
                yield client_1.prisma.recordTarifBongkar.createMany({ data: recordStevedoringData });
            }
            if (recordWageData.length > 0) {
                yield client_1.prisma.recordGaji.createMany({ data: recordWageData });
            }
            const teamMemberCounts = yield client_1.prisma.team.groupBy({
                by: ["idGroupTeam"],
                _count: {
                    id: true,
                },
            ...
            const detailLaporanData = sesiBongkarList.map((sesi) => {
                ...
                const resolvePrice = (isWrapping) => {
                    ...
                    const getScore = (t) => {
                        ...
                        if (t.idContainerSize === sesi.idContainerSize)
                            score += 100;
                        else if (((_b = (_a = t.containerSize) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === "all" || ((_d = (_c = t.containerSize) === null || _c === void 0 ? void 0 : _c.name) === null || _d === void 0 ? void 0 : _d.toLowerCase()) === "all size" || ((_f = (_e = t.containerSize) === null || _e === void 0 ? void 0 : _e.name) === null || _f === void 0 ? void 0 : _f.toLowerCase()) === "alllcl")
                            score += 50;
                        else
                            return -1;
                        if (t.idBarang === sesi.idBarang)
                            score += 10;
                        else if (((_h = (_g = t.barang) === null || _g === void 0 ? void 0 : _g.name) === null || _h === void 0 ? void 0 : _h.toLowerCase()) === "all")
                            score += 5;
                        else
                            return -1;
                        if (t.idAngkut === sesi.idAngkut)
                            score += 2;
                        else if (((_k = (_j = t.angkut) === null || _j === void 0 ? void 0 : _j.name) === null || _k === void 0 ? void 0 : _k.toLowerCase()) === "all")
                            score += 1;
                        else
                            return -1;
                        return score;
                ...
                const teamMemberCount = ((_c = teamMemberCounts.find((t) => t.idGroupTeam === sesi.idGroupTeam)) === null || _c === void 0 ? void 0 : _c._count.id) || 1;
        ...
        this.update = (id, body) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield client_1.prisma.recordTarifBongkar.deleteMany({ where: { idLaporan: id } });
            yield client_1.prisma.recordGaji.deleteMany({ where: { idLaporan: id } });
            const whereSesi = {
                startAT: {
                    gte: tanggalAwal,
                    lte: tanggalAkhir,
