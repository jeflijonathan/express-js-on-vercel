...
exports.thinBorder = void 0;
exports.applyBorderToRange = applyBorderToRange;
exports.thinBorder = {
    top: { style: "thin" },
    left: { style: "thin" },
    bottom: { style: "thin" },
...
function applyBorderToRange(ws, startRow, endRow, startCol, endCol) {
    for (let r = startRow; r <= endRow; r++) {
        for (let c = startCol; c <= endCol; c++) {
            ws.getCell(r, c).border = exports.thinBorder;
        }
    }
}
const HeaderTarifBongkar = (ws, startCol, row, isBarangAll = false) => {
    let col = startCol;
    if (isBarangAll) {
...
exports.default = HeaderTarifBongkar;
