...
class TarifBongkarService {
    constructor() {
        this.findTarifBongkarMuat = (req_1, ...args_1) => __awaiter(this, [req_1, ...args_1], void 0, function* (req, params = {}, queryParams = {}) {
            ...
            const [data, total] = yield Promise.all([
                this._bongkarRepository.findAll(where, {
                    page,
                    limit,
                }, {
                    select: {
        ...
        this.batchSaveTarifBongkarMuat = (body) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const item of items) {
                const { idTradeType, idContainerSize, idAngkut, idBarang, amount, jasaWrapping, } = item;
                const existing = yield this._bongkarRepository.findOne({
                    idBarang,
                    idContainerSize,
                    idTradeType,
                ...
                if (existing) {
                    results.push(yield this._bongkarRepository.updateTarifBongkar(existing.id, {
                        amount,
                    }));
                }
                else {
