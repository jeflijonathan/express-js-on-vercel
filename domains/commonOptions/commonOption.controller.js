...
class CommonOptionsController extends baseController_1.default {
    ...
    getStatusBongkarMuat() {
        this.router.get("/status-bongkar", auth_1.authenticateToken, (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield this.CommonOptionService.findStatusBongkar();
