...
class BongkarMuatController extends baseController_1.default {
    ...
    update() {
        this.router.put("/bongkar-muat/:id", auth_1.authenticateToken, (0, auth_1.authorizeRoles)("MANAJER", "SPV"), (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            try {
                const userRole = (_c = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role) === null || _b === void 0 ? void 0 : _b.name) === null || _c === void 0 ? void 0 : _c.toUpperCase();
                if (userRole === "ADMIN") {
                ...
                const result = yield this.bongkarMuatService.updateSesiBongkarMuat(req.params.id, req.body, isOpen);
